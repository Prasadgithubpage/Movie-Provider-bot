...
API_ID = int(environ.get('API_ID', '24595585'))
API_HASH = environ.get('API_HASH', 'ccebb6b746ccc5910830d640b3cf1ec4')
BOT_TOKEN = environ.get('BOT_TOKEN', "7114489500:AAE1EsMiFnUHz81QwADAogSqbPMiwBx1CGk")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5450311131').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002115616141').split()] #Channel id for auto indexing ( make sure bot is admin )
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://learnertrading154:F0H4iwNf6h55dqQV@cluster0.txajjlx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
